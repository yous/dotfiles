...
alias gf='git fetch'
alias gl='git pull'
alias glg='git log --graph --pretty=format:"%Cred%h %Cgreen%ar %C(bold blue)%an%Creset %s%C(yellow)%d%Creset"'
alias glga='git log --graph --pretty=format:"%Cred%h %Cgreen%ar %C(bold blue)%an%Creset %s%C(yellow)%d%Creset" --all'
